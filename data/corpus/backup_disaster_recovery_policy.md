...
that is captured is retained for 90 days from the date it was
captured, after which it is purged automatically as part of routine
backup rotation. This 90-day window exists to support disaster
recovery and point-in-time restoration in the event of a system
failure, data corruption incident, or accidental deletion of
infrastructure.
